                                   ...
                                   (div `(,(class "inner_tab" "open"))
                                        ...
                                        (div `(,(class "content"))
                                             (div `(,(style "display: flex; flex-direction: column"))
                                                  ...
                                                  (button `(,(onclick "_set_font('Ubuntu Mono')")) "ubuntu mono")
                                                  (button `(,(onclick "_set_font('Inconsolata')")) "inconsolata")
                                                  (button `(,(onclick "_set_font('Source Code Pro')")) "source code pro")
                                                  (button `(,(onclick "_set_font('IBM Plex Mono')")) "ibm plex mono")
                                                  ...
                                                  (button `(,(onclick "_set_font('Montserrat')")) "montserrat")
                                                  (button `(,(onclick "_set_font('Roboto')")) "roboto")
                                                  (button `(,(onclick "_set_font('Fira Sans')")) "fira sans")
                                                  (button `(,(onclick "_set_font('Ubuntu')")) "ubuntu")
                                                  (button `(,(onclick "_set_font('IBM Plex Sans')")) "ibm plex sans")
                                                  (button `(,(onclick "_set_font('sans')")) "default")
                                                  "serif"
                                                  (button `(,(onclick "_set_font('Vollkorn')")) "vollkorn")
                                                  (button `(,(onclick "_set_font('DM Serif Text')")) "dm serif")
                                                  (button `(,(onclick "_set_font('Josefin Slab')")) "josefin slab")
                                                  (button `(,(onclick "_set_font('EB Garamond')")) "garamond")
